...
@variables t
@parameters d kr L c w_rh w_t w_m w_q w_BA w_R θ_rh θ_nr Kq nq Vmax_init Km_init nrh nx nR nA nB gmax Kgamma M kb ku abx kon koff vt vm s0 Kt Km km_a km_b krep kdam_p ktag kdeg k_diss ns
species_comb1 = @syms m_rh(t) m_t(t) m_m(t) m_q(t) m_R(t) m_A(t) m_B(t) c_rh(t) c_t(t) c_m(t) c_q(t) c_R(t) c_A(t) c_B(t) et(t) em(t) q(t) R(t) A(t) B(t) rh(t) rt(t) rd(t) z_rh(t) z_t(t) z_m(t) z_q(t) z_R(t) z_A(t) z_B(t) si(t) a(t) 
species_comb = [Symbol(i) for i in species_comb1]

D = Differential(t)

@mtkmodel COMBINED_MODEL begin
    @parameters begin
        d 
        kr 
        L 
...
@mtkbuild combined_model = COMBINED_MODEL()
