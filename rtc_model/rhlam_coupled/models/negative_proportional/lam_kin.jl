...
init_rtc = [lam_kin.rm_a=>0.0,lam_kin.rtca=>0.0,lam_kin.rm_b=>0.0,lam_kin.rtcb=>0.0,lam_kin.rm_r=>0.0,lam_kin.rtcr=>0.0,lam_kin.rh=>11.29,lam_kin.rd=>0.0,lam_kin.rt=>0.0]

ssvals_rtc = steady_states(lam_kin, init_rtc, params_rtc1)

kdam_range = range(0,5, length=100) 

df_ssvals = var_param(lam_kin, kdam, params_rtc1, kdam_range, ssvals_rtc)

jac_sym=calculate_jacobian(lam_kin)
