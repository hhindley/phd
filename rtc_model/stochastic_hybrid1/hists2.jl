...
dfs = [DataFrame(CSV.File(joinpath("$PATH/stochastic_hybrid/threshold_testing2", file), header=["time", "rm_a", "rh", "TotProp"])) for file in readdir("$PATH/stochastic_hybrid/threshold_testing2")]
