...
res = change_param(kdam_range, :kdam, rtc_trna_inhib_model_rtca, init_trna_inhib, get_ssval, trna_species_inhib, params_trna_inhib)

trna_h_p = plot(scatter(x=kdam_range, y=res[:trna], name="tRNA"))
...
res_trna1 = checking_bistability(rtc_trna_inhib_model_rtcb, params_trna_inhib, init_trna_inhib, :trna, trna_species_inhib, kdam_range)
res_trna2 = checking_bistability(rtc_trna_inhib_model_rtcb, params_trna_inhib, init_trna_inhib, :trna, trna_species_inhib, kdam_range2)
...
res_trna3 = checking_bistability(rtc_trna_inhib_model_rtca, params_trna_inhib, init_trna_inhib, :trna, trna_species_inhib, kdam_range)
res_trna4 = checking_bistability(rtc_trna_inhib_model_rtca, params_trna_inhib, init_trna_inhib, :trna, trna_species_inhib, kdam_range2)
ptrna3 = scatter(x=kdam_range, y=res_trna3, name="↑ kdam", legendgroup=3, line=attr(color="#e377c2"))
...
ptrna5 = scatter(x=kdam_range, y=res_trna5, name="↑ kdam", legendgroup=3, line=attr(color="#e377c2"))
ptrna6 = scatter(x=kdam_range2, y=res_trna6, name="↓ kdam", legendgroup=4, line=attr(color="#9467bd"))
trna = plot([ptrna5, ptrna6])
...
br_rtcb_inhib = get_br(rtc_trna_inhib_mod_rtcb, params_trna_inhib_bf, init_trna_inhib, 400.)
bs = plot_all_curves_bistable(br, colors2, colorsr, "Original, L = 10")

br_rtca_inhib = get_br(rtc_trna_inhib_mod_rtca, params_trna_inhib_bf, init_trna_inhib, 350.)
bs = plot_all_curves_bistable(br, colors2, colorsr, "Original, L = 10")
