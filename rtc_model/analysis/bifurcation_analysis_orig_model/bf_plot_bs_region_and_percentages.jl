...
# savefig(all_ranges, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/all_ranges.svg")
# savefig(atp_wab, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/wab_atp_bigger_range.svg")
plot(atp_wab, atp_wr)
...
# savefig(p_all, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_all.svg")
...
# savefig(p_atplam_wab, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_atplam_wab.svg")
...
# savefig(p_atpkin_wab, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_atpkin_wab.svg")
...
# savefig(p_lamkin_wab, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_lamkin_wab.svg")
...
# savefig(p_atlam_wr, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_atlam_wr.svg")
...
# savefig(p_kinatp_wr, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_kinatp_wr.svg")
...
# savefig(p_kinlam_wr, "$PATHmay23_rtc/analysis/bifurcation_analysis/plots/p_kinlam_wr.svg")
