...
solu_trna_inhib_rtca = sol(rtca_trna_inhib_model, init_trna_inhib_rtca, tspan, params_trna_inhib)
ssvals_trna_rtca = get_all_ssvals(solu_trna_inhib_rtca, species_trna_inhib)

solu_trna_inhib_rtcb = sol(rtcb_trna_inhib_model, init_trna_inhib_rtcb, tspan, params_trna_inhib)
ssvals_trna_rtcb = get_all_ssvals(solu_trna_inhib_rtcb, species_trna_inhib)

solu_trna_inhib_rtcr = sol(rtcr_trna_inhib_model, init_trna_inhib_rtcr, tspan, params_trna_inhib)
ssvals_trna_rtcr = get_all_ssvals(solu_trna_inhib_rtcr, species_trna_inhib)
...
rtcb_auc = all_area_under_curve_rh(rtcb_trna_inhib_model, params_trna_inhib, ssvals_trna_rtcb, 20., k_trna_inhib_vals)
rtcr_auc = all_area_under_curve_rh(rtcr_trna_inhib_model, params_trna_inhib, ssvals_trna_rtcr, 20., k_trna_inhib_vals)
rtca_auc = all_area_under_curve_rh(rtca_trna_inhib_model, params_trna_inhib, ssvals_trna_rtca, 20., k_trna_inhib_vals)
...
percentage_size_rtcb = bf_size(rtcb_trna_inhib_model, ssvals_trna_rtcb, params_trna_inhib, 20., k_trna_inhib_vals)
percentage_size_rtca = bf_size(rtca_trna_inhib_model, ssvals_trna_rtca, params_trna_inhib, 20., k_trna_inhib_vals)
percentage_size_rtcr = bf_size(rtcr_trna_inhib_model, ssvals_trna_rtcr, params_trna_inhib, 20., k_trna_inhib_vals)

rtcb_dec = protein_decrease(rtcb_trna_inhib_model, ssvals_trna_rtcb, params_trna_inhib, :rtcb, 20., k_trna_inhib_vals)
# rtcb_dec_rh = protein_decrease(rtc_inhib_mod_rtcb, :rh)
rtca_dec = protein_decrease(rtca_trna_inhib_model, ssvals_trna_rtca, params_trna_inhib, :rtca, 20., k_trna_inhib_vals)
# rtca_dec_rh = protein_decrease(rtc_inhib_mod_rtca, :rh)
rtcr_dec = protein_decrease(rtcr_trna_inhib_model, ssvals_trna_rtcr, params_trna_inhib, :rtcr, 20., k_trna_inhib_vals)
