...
# using Plots
using PlotlyJS, ProgressBars, ModelingToolkit
...
include("/home/hollie_hindley/Documents/paper/init_switch_2024/init_switch_funcs.jl");
...
for kdam_val in ProgressBar(kdam_range_onoff)
    ...
    psm[kdam] = kdam_val
    branches1 = setup_ssvals_from_bfkit(rtc_model, kdam_val, params_rtc, ssvals_rtc, 1.5)
    # @show psm
...
CSV.write("/home/hollie_hindley/Documents/init_switch_paper/init_switch_2024/switch_vals_paper_2202.csv", svals_onoff)
