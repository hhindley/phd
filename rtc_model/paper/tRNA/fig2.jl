...
rh1, rh2, rh3 = plot_rtc_bf(df, kdam1, kdam2, :rh, "1", "ffd30cff", "rh", "y1")
rt1, rt2, rt3 = plot_rtc_bf(df, kdam1, kdam2, :rt, "2", "e96100ff", "rt", "y1")
rd1, rd2, rd3 = plot_rtc_bf(df, kdam1, kdam2, :rd, "3", "ac0606ff", "rd", "y2")
...
p1 = plot([fa1, fa2, fa3,rtcr1, rtcr2, rtcr3, ],
Layout(xaxis_title="Damage rate (min<sup>-1</sup>)", 
yaxis_title="Rtc protein (μM)",
yaxis=attr(showline=true,linewidth=3,linecolor="black"),yaxis2=attr(overlaying="y",showline=true,linewidth=3,linecolor="black",side="right"),xaxis=attr(showline=true,linewidth=3,linecolor="black"),
...
yaxis_title="Ribosomes (μM)", 
yaxis=attr(showline=true,linewidth=3,linecolor="black"),xaxis=attr(showline=true,linewidth=3,linecolor="black"),
xaxis_showgrid=false,yaxis_showgrid=false,yaxis2_showgrid=false,plot_bgcolor="white",font=attr(size=24, color="black", family="sans-serif"), showlegend=false))#, yaxis_tickangle=77))
...
savefig(p, "/home/holliehindley/phd/rtc_model/paper_plots/tRNA/plots/rtc_proteinBA.svg")
savefig(p1, "/home/holliehindley/phd/rtc_model/paper_plots/tRNA/plots/rtcr_fa.svg")
savefig(p2, "/home/holliehindley/phd/rtc_model/paper_plots/tRNA/plots/rh.svg")
savefig(p3, "/home/holliehindley/phd/rtc_model/paper_plots/tRNA/plots/rt_rd.svg")
