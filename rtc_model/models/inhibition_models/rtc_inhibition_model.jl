...
@syms rm_a(t) rtca(t) rm_b(t) rtcb(t) rm_r(t) rtcr(t) rh(t) rd(t) rt(t) rtc_i(t)
    ...
    @mtkmodel RTC_INHIB begin
        ...
        @equations begin
            ...
            if inhib_protein == :rtca_inhib
                ...
                rhs_rtca ~ (1/na)*kc*rh*rm_a*(g_max*atp/(θtlr+atp)) - lam*(rtca) - k_inhib1*rtca*inhib + k_inhib2*rtc_i   
            ...
            elseif inhib_protein == :rtcb_inhib
                ...
                rhs_rtcb ~ (1/nb)*kc*rh*rm_b*(g_max*atp/(θtlr+atp)) - lam*(rtcb) - k_inhib1*rtcb*inhib + k_inhib2*rtc_i   
                rhs_rtcr ~ (1/nr)*kc*rh*rm_r*(g_max*atp/(θtlr+atp)) - lam*(rtcr)
            else 
                rhs_rtc_i ~ k_inhib1*rtcr*inhib - k_inhib2*rtc_i - lam*(rtc_i)            
                rhs_rtca ~ (1/na)*kc*rh*rm_a*(g_max*atp/(θtlr+atp)) - lam*(rtca)
                rhs_rtcb ~ (1/nb)*kc*rh*rm_b*(g_max*atp/(θtlr+atp)) - lam*(rtcb) 
                rhs_rtcr ~ (1/nr)*kc*rh*rm_r*(g_max*atp/(θtlr+atp)) - lam*(rtcr) - k_inhib1*rtcr*inhib + k_inhib2*rtc_i   
            end
