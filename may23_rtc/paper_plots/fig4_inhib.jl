...
function creating_rtc_inhib_plot(rtc_inhib_mod, specie)
    params2 = (L = 10., c = 0.001, kr = 0.125, Vmax_init = 39.51, Km_init = 250.,
    θtscr = 160.01, θtlr = 255.73, na = 338., nb = 408., nr = 532. *6, d = 0.2, 
    krep = 137., ktag = 9780., atp = 3578.9473684210525, km_a = 20., km_b = 16., g_max = 2.0923, 
    kdeg = 0.001, kin = 0.022222222, ω_ab = 0.05623413251903491, ω_r = 0.010000000000000002, 
    ...
    rtcb_01, rtcb_02, rtcb_03, bf_rtcb0 = plot_rtc_bf(bf0, df0, kdam01, kdam02, specie)

    bf, df, kdam1, kdam2 = different_levels_inhibition(rtc_inhib_mod, k_inhib1, k_inhib2, inhib)
    rtcb1, rtcb2, rtcb3, bf_rtcb = plot_rtc_bf(bf, df, kdam1, kdam2, specie)

    bfa, dfa, kdam1a, kdam2a = different_levels_inhibition(rtc_inhib_mod, k_inhib1a, k_inhib2, inhib)
    rtcb1a, rtcb2a, rtcb3a, bf_rtcba = plot_rtc_bf(bfa, dfa, kdam1a, kdam2a, specie)

    bfb, dfb, kdam1b, kdam2b = different_levels_inhibition(rtc_inhib_mod, k_inhib1b, k_inhib2, inhib)
    rtcb1b, rtcb2b, rtcb3b, bf_rtcbb = plot_rtc_bf(bfb, dfb, kdam1b, kdam2b, specie)
    return [rtcb_01, rtcb_02, rtcb_03, bf_rtcb0, rtcb1, rtcb2, rtcb3, bf_rtcb, rtcb1a, rtcb2a, rtcb3a, bf_rtcba, rtcb1b, rtcb2b, rtcb3b, bf_rtcbb]
end



rtcb_traces = creating_rtc_inhib_plot(rtc_inhib_mod_rtcb, :rtcb)
...
rtca_traces = creating_rtc_inhib_plot(rtc_inhib_mod_rtca, :rtca)
...
rtcr_traces = creating_rtc_inhib_plot(rtc_inhib_mod_rtcr, :rtcr)
