...
c_range1 = 10 .^range(-4,0, length=30)

p = param2x_plot_same_species(L_range1, :L, atp_range, :atp, :rt)
save_plot(p, "rt", "atp_L")


p1 = param2x_plot_same_species(L_range1, :L, atp_range, :atp, :rm_a)
save_plot(p, "rm_a", "atp_L")


p2 = param2x_plot_same_species(c_range1, :c, atp_range, :atp, :rd)
save_plot(p, "rd", "atp_L")
