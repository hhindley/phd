...
function rtc_bo_colD(;kdam)
    ...
    obj_nA_colD = obj_OD(rtc_model_knockout_OD, (@SVector [rm_a_0, rtca_0, rm_b_0, rtcb_0, rm_r_0, rtcr_0, rh_0, rd_0, rt_0, OD_0_wtcolD]), (@SVector [L, c, kr, Vmax_init, Km_init, 0, ω_a, ω_r, θtscr, g_max, θtlr, km_a, km_b, gr_c, d, krep, kdam, ktag, kdeg, kin, atp, na, nb, nr, findmax(nA_colD)[1]]), tspan4, t_4, "OD", nA_colD, nA_colD_std)
    obj_nB_colD = obj_OD(rtc_model_knockout_OD, (@SVector [rm_a_0, rtca_0, rm_b_0, rtcb_0, rm_r_0, rtcr_0, rh_0, rd_0, rt_0, OD_0_wtcolD]), (@SVector [L, c, kr, Vmax_init, Km_init, ω_a, 0, ω_r, θtscr, g_max, θtlr, km_a, km_b, gr_c, d, krep, kdam, ktag, kdeg, kin, atp, na, nb, nr, findmax(nB_colD)[1]]), tspan4, t_4, "OD", nB_colD, nB_colD_std)
    obj_nBB_colD = obj_OD(rtc_model_OD, (@SVector [rm_a_0, rtca_0, rm_b_0, rtcb_0, rm_r_0, rtcr_0, rh_0, rd_0, rt_0, OD_0_wtcolD]), (@SVector [L, c, kr, Vmax_init, Km_init, ω_ab, ω_r, θtscr, g_max, θtlr, km_a, km_b, gr_c, d, krep, kdam, ktag, kdeg, kin, atp, na, nb, nr, findmax(nB_B_colD)[1]]), tspan4, t_4, "OD", nB_B_colD, nB_B_colD_std)
    obj_nBBmut_colD = obj_OD(rtc_model_knockout_OD, (@SVector [rm_a_0, rtca_0, rm_b_0, rtcb_0, rm_r_0, rtcr_0, rh_0, rd_0, rt_0, OD_0_wtcolD]), (@SVector [L, c, kr, Vmax_init, Km_init, ω_a, 0, ω_r, θtscr, g_max, θtlr, km_a, km_b, gr_c, d, krep, kdam, ktag, kdeg, kin, atp, na, nb, nr, findmax(nB_Bmut_colD)[1]]), tspan4, t_4, "OD", nB_Bmut_colD, nB_Bmut_colD_std)
    obj_nR_colD = obj_OD(rtc_model_OD, (@SVector [rm_a_0, rtca_0, rm_b_0, rtcb_0, rm_r_0, rtcr_0, rh_0, rd_0, rt_0, OD_0_wtcolD]), (@SVector [L, c, kr, Vmax_init, Km_init, ω_ab, 0, θtscr, g_max, θtlr, km_a, km_b, gr_c, d, krep, kdam, ktag, kdeg, kin, atp, na, nb, nr, findmax(nR_colD)[1]]), tspan4, t_4, "OD", nR_colD, nR_colD_std)
