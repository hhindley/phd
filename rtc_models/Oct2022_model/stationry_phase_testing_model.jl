...
p_justlam = solvePlot_time(rtc_model1!, lam_t, 4000, 0.054, "just λ varied over time", "log")
...
p_lamkin = solvePlot_time(lam_kin_t, lam_t, 4000, kin_t, "kin and λ varied over time", "log")
