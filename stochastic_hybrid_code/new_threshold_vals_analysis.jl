...
mount_path = "/Users/s2257179"
folder = "new_thresh_vals_0507_final_files"
hist_path = joinpath(mount_path, "new_thresh_vals_0507_hists")
...
df_times = CSV.File("/Users/s2257179/new_thresh_vals_0507_times.csv") |> DataFrame
...
f = plot_results("plot_stoch_reacts", df_reacts, 10, xlabel="reaction", ylabel="count", titles=titles, hidelabels=[true, true], linkaxes=true, species="stoch_reacts")#, folder="thresh_plots")
display(f)
...
f_rtca = plot_results("plot_results", df_results, 10, species=:rtca, xlabel="time", ylabel="rtca", titles=titles, folder="testing_figs")
...
rma_hist = plot_results("plot_hists", dfs, 10, species=:rtca, xlabel="rh conc", ylabel="frequency", titles=titles)#, folder="thresh_plots2/hists")
