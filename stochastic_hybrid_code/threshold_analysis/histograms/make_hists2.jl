...
for file in files
    ...
    if !isdir("/home/hollie_hindley/Documents/stochastic_hybrid/hists2/$(file[1:end-6])")
        mkdir("/home/hollie_hindley/Documents/stochastic_hybrid/hists2/$(file[1:end-6])")
    end
    for i in [:rm_a, :rm_b, :rm_r, :rtca, :rtcb, :rtcr, :rh, :rt, :rd]
        ...
        CSV.write("/home/hollie_hindley/Documents/stochastic_hybrid/hists2/$(file[1:end-6])/$i.csv", hist_freq)
    end
end
